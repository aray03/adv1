...
Since the alternating sum $11$ is divisible by 11 ($11 = 11 \cdot 1$), then our 64 digit number $X$ is also divisible by 11 based on Theorem 2.

\subsection*{Conclusion}
Because $X$ has a divisor $a = 11$ such that $11$ divides $X$[cite: 240], and $X$ is clearly greater than 11, $X$ satisfies the definition of a composite number. By the definition of a divisor in Definition 4 (page 12), $X$ cannot be prime[cite: 240]. Thus, no ordering of the years 2011 to 2026 can result in a prime number.		

		...
		\begin{questions}
			...
			\begin{parts}
				...
				\begin{solution}
                    ...
                    Showing the initial values, leading up to the recursive formula for $T_n$:

                    $T_0 =1$

                    $T_1 =1$ (Using a single $1 \times 1$ tile)

                    $T_2 =2$ (Using either two $1 \times 1$ tiles or a single $1 \times 2$ tile)

                    $T_3 =3$ (Using either three $1 \times 1$ tiles, or a $1 \times 2$ tile and a $1 \times 1$ tile, in different orders)

                    $T_4 =5$ (Using either four $1 \times 1$ tiles, or a combination of $1 \times 2$ tiles and $1 \times 1$ tiles, or two $1 \times 2$ tiles)
